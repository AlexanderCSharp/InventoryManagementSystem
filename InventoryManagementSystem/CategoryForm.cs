    ...
    public partial class CategoryForm : Form
    {
        ...
        private void dgvCategory_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Edit")
            {
                ...
                formModule.txtСatName.Text = dgvCategory.Rows[e.RowIndex].Cells[2].Value.ToString();
            ...
            {
                if (MessageBox.Show("Вы уверены, что хотите удалить эту категорию?", "Удалить запись", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    con.Open();
