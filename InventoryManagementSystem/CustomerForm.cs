    ...
    public partial class CustomerForm : Form
    {
        ...
        private void dgvCustomer_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Edit")
            {
                ...
                customerModule.txtСName.Text = dgvCustomer.Rows[e.RowIndex].Cells[2].Value.ToString();
                customerModule.txtСPhone.Text = dgvCustomer.Rows[e.RowIndex].Cells[3].Value.ToString();
            ...
            {
                if (MessageBox.Show("Вы уверены, что хотите удалить этого клиента?", "Удалить запись", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    con.Open();
